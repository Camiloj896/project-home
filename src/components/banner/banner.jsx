      ...
      <div className='bg-shadow-fmc'>
        <div className="grid max-w-screen-xl px-4 py-14 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7 banner-ls">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-100 lg:mb-8 md:text-lg lg:text-x">Libera tú ingenio en nuestra plataforma de freestyle. Descubre tu ritmo único y perfecciona tu arte en cada improvisación junto a nosotros.</p>
